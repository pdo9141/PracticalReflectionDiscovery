...
namespace OrderRule.Discount
{
    public class CustomerDiscountRule : IOrderRule
    {
        ...
        {
            get { return "Customer Discount Rule"; }
        }
        ...
        public OrderRuleResult CheckRule(Order order)
        {
            ...
            switch (order.Customer.Rating)
            {
                ...
                case 6:
                    ...
                    {
                        passed = false;
                        message = String.Format("Maximum 5% discount for Customers with a Rating of {0}", order.Customer.Rating);
                    }
                    break;
                case 7:
                case 8:
                    ...
                    {
                        passed = false;
                        message = String.Format("Maximum 10% discount for Customers with a Rating of {0}", order.Customer.Rating);
                    }
                    break;
                case 9:
                case 10:
                    ...
                    {
                        passed = false;
                        message = String.Format("Maximum 15% discount for Customers with a Rating of {0}", order.Customer.Rating);
                    }
                    break;
                default:
                    break;
